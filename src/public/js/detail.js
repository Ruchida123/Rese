  ...
  function changeTimeSelectValue(val, timeVal) {
    ...
    if (compareDateOnly(dtToday, dtSelectVal)) {
      ...
      for (var _i = 0; _i < 24; _i++) {
        time_table.push({
          value: ('0' + _i).slice(-2) + ':00',
          label: ('0' + _i).slice(-2) + ':00'
        });
        time_table.push({
          value: ('0' + _i).slice(-2) + ':30',
          label: ('0' + _i).slice(-2) + ':30'
        });
      }
      ;
    }
    ...
    time_table.forEach(function (table) {
      ...
      if (table.value == timeVal) {
        $('select[class="reserve__time-item"]').append($("<option>").attr({
          value: table.value
        }).prop('selected', true).text(table.label));
      } else {
        $('select[class="reserve__time-item"]').append($("<option>").attr({
          value: table.value
        }).text(table.label));
